...
public interface ApiInterface {
    ...
    Call<User> updateProfileEmpNormal(@Part("name") String name,
                                      @Part("phone") String phone,
    ...
    @Multipart
    @POST("user/update-profile")
    Call<User> updateProfileEmp(@Part("name") String name,
                                @Part("phone") String phone,
                                @Part("_method") String _method,
    ...
    @Multipart
    @POST("user/update-profile")
    Call<User> updateProfileUserNormal(@Part("name") String name,
                                       @Part("phone") String phone,
                                       @Part("_method") String _method
    );
    ...
    Call<MsSaveJob> editJobEmp(@Path("id") int id,
                               @Field("description") String description,
